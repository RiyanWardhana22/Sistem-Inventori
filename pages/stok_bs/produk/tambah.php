...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-primary text-white">
            <h6 class="m-0 font-weight-bold">Import Data Barang Rusak (BS)</h6>
        </div>
        <div class="card-body">
            <div class="alert alert-info">
                ...
                <ol>
                    ...
                    <li>Isi data BS sesuai format</li>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-primary text-white">
            <h6 class="m-0 font-weight-bold">Tambah Data BS Manual</h6>
        </div>
        <div class="card-body">
            ...
            <form action="proses.php" method="POST" id="bsForm">
                <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="tanggalBs" name="tanggal_bs" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
