...
<div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h3">Stok Keluar (Pencatatan Penjualan)</h1>
</div>
...
<div class="card mb-4">
            ...
            <div class="card-body">
                        <form action="proses.php" method="POST">
                                    <input type="hidden" name="action" value="tambah_stok_keluar">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                            <div class="mb-3">
                                                                        <label for="jumlah" class="form-label">Jumlah Terjual (pcs)</label>
                                                                        <input type="number" class="form-control" id="jumlah" name="jumlah" min="1" required>
                                                            </div>
                                                </div>
                                                <div class="col-md-3 d-flex align-items-end">
                                                            <div class="mb-3">
                                                                        <button type="submit" class="btn btn-success"><i class="fas fa-cart-arrow-down"></i> Catat Penjualan</button>
                                                            </div>
                                                </div>
                                    </div>
                        </form>
                    ...
                    ");
                                                            ...
                                                            ?>
                                                                        <tr>
                                                                                    ...
                                                                                    <td><strong class="text-danger">-<?php echo $data['jumlah']; ?> pcs</strong></td>
                                                                        </tr>
                                                            <?php } ?>
                                                </tbody>
                                    </table>
