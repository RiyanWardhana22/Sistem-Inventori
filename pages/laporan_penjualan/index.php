...
<div>
  <a href="cetak_pdf.php?tanggal_mulai=<?php echo $tanggal_mulai; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>" target="_blank" class="btn btn-danger"><i class="fas fa-file-pdf me-2"></i>Cetak PDF</a>
  <a href="export_csv.php?tanggal_mulai=<?php echo $tanggal_mulai; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>" class="btn btn-success"><i class="fas fa-file-excel me-2"></i>Export Excel (CSV)</a>
</div>
