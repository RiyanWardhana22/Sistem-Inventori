...
$stmt = $pdo->prepare("
    SELECT ob.*, b.nama_bahan 
    FROM opname_bahan ob 
    JOIN bahan b ON ob.nama_bahan = b.nama_bahan 
    WHERE ob.tanggal_opname BETWEEN ? AND ? 
    ORDER BY ob.tanggal_opname DESC, b.nama_bahan ASC
");
...
<div class="card mb-4">
    <div class="card-header bg-white border-0 pb-0">
        <div class="my-2">
            <h1 class="h3 mb-0">Laporan Opname Bahan</h1>
        </div>
        <hr>
            ...
            <table class="table table-modern">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='7' class='text-center py-4'>Tidak ada data opname bahan pada rentang tanggal yang dipilih.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
