...
$count_sql = "SELECT COUNT(*) FROM opname_bahan";
    ...
    <div class="card-header">
        <div class="row align-items-center mb-4">
            <div class="col-sm-6 my-2">
                <h1 class="h3 mb-0">Manajemen Opname Bahan</h1>
            </div>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo is_numeric($row['penggunaan']) ? number_format($row['penggunaan'], 0, ',', '.') : '-'; ?></td>
                    ...
                    <?php
                        ...
                        echo '<tr><td colspan="9" class="text-center py-4">Tidak ada data opname ditemukan</td></tr>';
                    }
                    ?>
                </tbody>
            </table>
